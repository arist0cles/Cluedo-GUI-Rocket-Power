...
public class SetupPopup extends JOptionPane {
	...
	/**
	 * Opens a new window for each player to enter their name and select a char to be represented by
	 */
	public void setupEachPlayer() {
		//Closes the previous players window, or initially the number of players window
		closeWindow();
