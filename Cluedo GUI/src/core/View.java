...
/**
 * View class from MVC architecture. Displays state dynamically. 
 * Views are responsible for UI elements and displaying things. 
 * Controllers are responsible for connecting Views with Models 
 * and providing data for the View to display.
 * 
 * @author Patrick and Kirita
 *
 */
public class View extends JFrame {
	 ...
	 * @param e
	 *            An emptyborder object, to make sure the panels start with a
	 *            predetermined size
	 * @param layoutPosition
	 *            Either the left or the right, which are called east or west
	 */
